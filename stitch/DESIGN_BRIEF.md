...
- StackLens Canary iconFix 3 turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser tool called StackLens Canary IconFix 3. It should be a small operational dashboard for comparing module stack health across projects. Use a frontend web app stack, not a game. No database required. First viewport must be the actual dashboard with module cards, stack status, risk indic…
...
- Record Operations - Product
- Record Editor - Product
- Insights - Product

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Product
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Product
